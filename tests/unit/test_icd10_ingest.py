"""
test_icd10_ingest.py — Unit tests for the WHO ClaML ICD-10 normalization pipeline.
"""
...
if str(SRC_PATH / "scripts") not in sys.path:
    sys.path.insert(0, str(SRC_PATH / "scripts"))
